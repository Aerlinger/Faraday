...
draw2d.End.prototype.setWorkflow=function(_358f){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_358f);
if(_358f!==null&&this.inputPort===null){
this.inputPort=new draw2d.MyInputPort();
this.inputPort.setWorkflow(_358f);
...
this.inputPort2.setWorkflow(_358f);
...
this.inputPort3.setWorkflow(_358f);
...
this.inputPort4.setWorkflow(_358f);
