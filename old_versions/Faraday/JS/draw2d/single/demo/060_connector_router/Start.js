...
draw2d.Start.prototype.setWorkflow=function(_27aa){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_27aa);
if(_27aa!==null&&this.outputPort===null){
this.outputPort=new draw2d.MyOutputPort();
this.outputPort.setWorkflow(_27aa);
...
this.outputPort1.setWorkflow(_27aa);
...
this.outputPort2.setWorkflow(_27aa);
...
this.outputPort3.setWorkflow(_27aa);
