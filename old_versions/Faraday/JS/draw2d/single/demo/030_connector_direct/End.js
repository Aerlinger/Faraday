...
draw2d.End.prototype.setWorkflow=function(_272a){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_272a);
if(_272a!==null&&this.inputPort===null){
this.inputPort=new draw2d.InputPort();
this.inputPort.setWorkflow(_272a);
