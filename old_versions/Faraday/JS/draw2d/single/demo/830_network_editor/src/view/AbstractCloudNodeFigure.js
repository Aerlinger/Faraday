...
draw2d.AbstractCloudNodeFigure.prototype.createCommand=function(_35bc){
if(_35bc.getPolicy()===draw2d.EditPolicy.MOVE){
if(!this.canDrag){
return null;
}
return new draw2d.CommandMoveCloudNode(this.model);
}else{
if(_35bc.getPolicy()===draw2d.EditPolicy.DELETE){
return new draw2d.CommandRemoveCloudNode(this.model);
}
}
return draw2d.Node.prototype.createCommand.call(this,_35bc);
};
