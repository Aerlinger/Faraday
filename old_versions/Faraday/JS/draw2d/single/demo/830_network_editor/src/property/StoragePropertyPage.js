...
var _35c1=new draw2d.CommandChangeProperty(editor.getGraphicalViewer(),func,oThis.currentModel.getStorage(),oThis.storageText.value);
editor.executeCommand(_35c1);
});
}
...
var _35c3=new draw2d.CommandChangeProperty(editor.getGraphicalViewer(),func,oThis.currentModel.getQualifier(),oThis.qualifier.value);
editor.executeCommand(_35c3);
};
