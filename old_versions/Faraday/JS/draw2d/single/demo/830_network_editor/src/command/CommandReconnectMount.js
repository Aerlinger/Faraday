...
draw2d.CommandReconnectMount.prototype.setNewPorts=function(_1edd,_1ede){
this.newSourceModel=_1edd.getParent().getModel();
this.newTargetModel=_1ede.getParent().getModel();
};
