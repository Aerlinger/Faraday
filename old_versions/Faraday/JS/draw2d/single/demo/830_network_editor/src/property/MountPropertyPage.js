...
var _2d9c=new draw2d.CommandChangeProperty(editor.getGraphicalViewer(),func,oThis.currentModel.getOrder(),oThis.orderText.value);
editor.executeCommand(_2d9c);
});
}
