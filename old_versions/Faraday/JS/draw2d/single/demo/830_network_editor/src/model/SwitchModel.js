...
var _1d33=draw2d.AbstractCloudNodeModel.prototype.getPersistentAttributes.call(this);
_1d33.attributes.id=this.id;
if(this.dbid.length>0){
_1d33.dbid=this.dbid;
}
_1d33.name=this.name;
_1d33.representation=this.representation;
return _1d33;
};
