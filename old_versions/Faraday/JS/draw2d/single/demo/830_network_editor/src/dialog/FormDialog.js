...
var _1e25=Element.getDimensions(this.dialog_box);
var _1e26=Element.getDimensions(this.overlay);
this.dialog_box.style.left=((_1e26.width/2)-(_1e25.width/2))+"px";
...
var _1e29=Element.getDimensions(this.dialog_box);
this.dialog_box.style.left=((this.winWidth()/2)-(_1e29.width)/2)+"px";
this.dialog_box.style.top="40px";
...
_1e2b=window.innerWidth;
}else{
if(typeof document.documentElement!="undefined"&&typeof document.documentElement.clientWidth!="undefined"&&document.documentElement.clientWidth!=0){
_1e2b=document.documentElement.clientWidth;
}else{
_1e2b=document.getElementsByTagName("body")[0].clientWidth;
}
}
return _1e2b;
};
...
_1e2c=document.documentElement.clientHeight;
}else{
_1e2c=document.getElementsByTagName("body")[0].clientHeight;
}
}
return _1e2c;
};
