...
var _3937=draw2d.AbstractCloudNodeModel.prototype.getPersistentAttributes.call(this);
_3937["name"]=this["name"];
_3937["cpu-units"]=this["cpu-units"];
_3937["ram-in-mb"]=this["ram-in-mb"];
if(this.dbid.length>0){
_3937.dbid=this.dbid;
}
_3937.images=this.images;
_3937.nics=this.nics;
_3937.representation=this.representation;
_3937.attributes.id=this.id;
return _3937;
};
