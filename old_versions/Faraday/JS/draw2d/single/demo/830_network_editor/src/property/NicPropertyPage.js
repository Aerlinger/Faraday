...
var _1d3e=new draw2d.CommandChangeProperty(editor.getGraphicalViewer(),func,oThis.currentModel.getIpAddress(),oThis.ipAddressText.value);
editor.executeCommand(_1d3e);
});
}
