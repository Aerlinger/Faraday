...
draw2d.RoundCornerFigure.prototype.setContent=function(_38db){
this.textarea.innerHTML=_38db;
};
draw2d.RoundCornerFigure.prototype.onDragstart=function(x,y){
var _38de=draw2d.Node.prototype.onDragstart.call(this,x,y);
if(this.header===null){
return false;
}
...
draw2d.RoundCornerFigure.prototype.setWorkflow=function(_38e0){
draw2d.Node.prototype.setWorkflow.call(this,_38e0);
if(_38e0!==null&&this.inputPort===null){
this.inputPort=new draw2d.InputPort();
this.inputPort.setWorkflow(_38e0);
this.inputPort.setName("input");
this.addPort(this.inputPort,-5,this.height/2);
this.outputPort=new draw2d.OutputPort();
this.outputPort.setMaxFanOut(5);
this.outputPort.setWorkflow(_38e0);
