...
draw2d.ResizeImage.prototype.setWorkflow=function(_311b){
draw2d.Node.prototype.setWorkflow.call(this,_311b);
if(_311b!==null&&this.outputPort1===null){
this.outputPort1=new draw2d.OutputPort();
this.outputPort1.setMaxFanOut(1);
this.outputPort1.setWorkflow(_311b);
...
this.outputPort2.setWorkflow(_311b);
