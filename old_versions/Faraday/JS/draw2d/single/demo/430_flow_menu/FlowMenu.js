draw2d.FlowMenu=function(_2831){
...
draw2d.FlowMenu.prototype.setAlpha=function(_2832){
draw2d.Figure.prototype.setAlpha.call(this,_2832);
};
draw2d.FlowMenu.prototype.hasTitleBar=function(){
return false;
};
draw2d.FlowMenu.prototype.onSelectionChanged=function(_2833){
if(_2833==this.currentFigure){
return;
}
if(_2833 instanceof draw2d.Line){
return;
}
if(this.added==true){
...
if(_2833!==null&&this.added==false){
...
this.currentFigure=_2833;
if(this.currentFigure!==null){
this.currentFigure.attachMoveListener(this);
this.onOtherFigureMoved(this.currentFigure);
}
};
draw2d.FlowMenu.prototype.setWorkflow=function(_2834){
draw2d.Figure.prototype.setWorkflow.call(this,_2834);
};
draw2d.FlowMenu.prototype.onOtherFigureMoved=function(_2835){
var pos=_2835.getPosition();
this.setPosition(pos.x+_2835.getWidth()+7,pos.y-16);
};
