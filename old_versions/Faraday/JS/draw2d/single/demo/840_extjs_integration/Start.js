...
draw2d.Start.prototype.setWorkflow=function(_3789){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_3789);
if(_3789!==null&&this.outputPort===null){
this.outputPort=new draw2d.MyOutputPort();
this.outputPort.setWorkflow(_3789);
...
this.outputPort1.setWorkflow(_3789);
...
this.outputPort2.setWorkflow(_3789);
...
this.outputPort3.setWorkflow(_3789);
