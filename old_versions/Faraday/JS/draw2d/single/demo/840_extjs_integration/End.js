...
draw2d.End.prototype.setWorkflow=function(_2637){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_2637);
if(_2637!==null&&this.inputPort===null){
this.inputPort=new draw2d.MyInputPort();
this.inputPort.setWorkflow(_2637);
...
this.inputPort2.setWorkflow(_2637);
...
this.inputPort3.setWorkflow(_2637);
...
this.inputPort4.setWorkflow(_2637);
