...
var _2f21=this.model.getFieldModels();
for(var i=0;i<_2f21.getSize();i++){
this.addColumn(_2f21.get(i).getName(),_2f21.get(i).getExtendedDescriptionLabel());
}
};
...
draw2d.TableFigure.prototype.createCommand=function(_2f24){
if(_2f24.getPolicy()==draw2d.EditPolicy.MOVE){
if(!this.canDrag){
return null;
}
