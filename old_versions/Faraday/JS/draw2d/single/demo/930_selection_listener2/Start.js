...
draw2d.Start.prototype.setWorkflow=function(_3124){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_3124);
if(_3124!==null&&this.outputPort===null){
this.outputPort1=new draw2d.OutputPort();
this.outputPort1.setWorkflow(_3124);
...
this.outputPort2.setWorkflow(_3124);
...
this.outputPort3.setWorkflow(_3124);
...
this.outputPort4.setWorkflow(_3124);
