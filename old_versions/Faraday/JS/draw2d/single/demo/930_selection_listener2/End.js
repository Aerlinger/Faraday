...
draw2d.End.prototype.setWorkflow=function(_242d){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_242d);
if(_242d!==null&&this.inputPort===null){
this.inputPort1=new draw2d.InputPort();
this.inputPort1.setWorkflow(_242d);
...
this.inputPort2.setWorkflow(_242d);
...
this.inputPort3.setWorkflow(_242d);
...
this.inputPort4.setWorkflow(_242d);
