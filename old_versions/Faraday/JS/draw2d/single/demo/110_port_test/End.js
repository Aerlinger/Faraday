...
draw2d.End.prototype.setWorkflow=function(_2433){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_2433);
if(_2433!==null&&this.inputPort===null){
this.inputPort=new draw2d.MyInputPort();
this.inputPort.setName("input");
this.inputPort.setHideIfConnected(true);
this.inputPort.setWorkflow(_2433);
