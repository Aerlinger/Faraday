...
draw2d.ResizeImage.prototype.setWorkflow=function(_315f){
draw2d.Node.prototype.setWorkflow.call(this,_315f);
if(_315f!==null){
this.outputPort1=new draw2d.OutputPort();
this.outputPort1.setMaxFanOut(1);
this.outputPort1.setWorkflow(_315f);
...
this.outputPort2.setWorkflow(_315f);
