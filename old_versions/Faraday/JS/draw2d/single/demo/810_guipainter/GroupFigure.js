...
draw2d.GroupFigure.prototype.onFigureEnter=function(_1e19){
if(this.children[_1e19.id]===null){
this.setBackgroundColor(this.highlightBackgroundColor);
}
draw2d.CompartmentFigure.prototype.onFigureEnter.call(this,_1e19);
};
draw2d.GroupFigure.prototype.onFigureLeave=function(_1e1a){
draw2d.CompartmentFigure.prototype.onFigureLeave.call(this,_1e1a);
this.setBackgroundColor(this.defaultBackgroundColor);
};
draw2d.GroupFigure.prototype.onFigureDrop=function(_1e1b){
draw2d.CompartmentFigure.prototype.onFigureDrop.call(this,_1e1b);
this.setBackgroundColor(this.defaultBackgroundColor);
};
