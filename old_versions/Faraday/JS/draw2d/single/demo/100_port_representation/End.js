...
draw2d.End.prototype.setWorkflow=function(_3671){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_3671);
if(_3671!==null&&this.inputPort===null){
this.inputPort=new draw2d.InputPort();
this.inputPort.setWorkflow(_3671);
