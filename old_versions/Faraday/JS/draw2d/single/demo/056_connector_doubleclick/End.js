...
draw2d.End.prototype.setWorkflow=function(_3892){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_3892);
if(_3892!==null&&this.inputPort===null){
this.inputPort=new draw2d.MyInputPort();
this.inputPort.setName("input");
this.inputPort.setWorkflow(_3892);
