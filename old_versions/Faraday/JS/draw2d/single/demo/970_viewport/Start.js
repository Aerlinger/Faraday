...
draw2d.Start.prototype.setWorkflow=function(_2d97){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_2d97);
if(_2d97!==null&&this.outputPort===null){
this.outputPort=new draw2d.MyOutputPort();
this.outputPort.setWorkflow(_2d97);
...
this.outputPort1.setWorkflow(_2d97);
...
this.outputPort2.setWorkflow(_2d97);
...
this.outputPort3.setWorkflow(_2d97);
