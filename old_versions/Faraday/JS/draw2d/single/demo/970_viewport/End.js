...
draw2d.End.prototype.setWorkflow=function(_38a8){
draw2d.ImageFigure.prototype.setWorkflow.call(this,_38a8);
if(_38a8!==null&&this.inputPort===null){
this.inputPort=new draw2d.MyInputPort();
this.inputPort.setWorkflow(_38a8);
...
this.inputPort2.setWorkflow(_38a8);
...
this.inputPort3.setWorkflow(_38a8);
...
this.inputPort4.setWorkflow(_38a8);
